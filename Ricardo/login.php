...
<head>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous"><img src="https://static.hentaicdn.com/hentai/19621/1b/ccdn0001.jpg" width="80%" >
...
<body>
   <?php
     ...
     include('conexao.php');
      ?>
      <nav>
       <div id="legal"> <img src="legal1.jpeg" width="80%" ><br><br></div>
  <form method="post">
